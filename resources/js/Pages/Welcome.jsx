...
export default function JobList(props) {
    ...
    const upload = {
            ...
            if (info.file.status !== 'uploading') {
                console.log(info.file, info.response);
            }
        ...
        >
            ...
            <div className="py-12 ">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-20 text-center" style={{backgroundColor: 'rgba(255,255,255,0.4)'}}>
                    {back && <div  style={{float:'right'}}><PrimaryButton onClick={showBack}>Back </PrimaryButton></div>}
                    
                    {!ShowJobDetails &&   
                    <div className="p-100 text-black font-bold text-4xl text-center">Job Posting</div>
                    }
                    <br /> <br />
                        {!ShowJobDetails &&
                    ...
                    <React.Fragment>
                        {Jobs.map((item, index) => (
                        <div >
                                <div className="p-100 text-gray-900 font-bold text-3xl"> {item.Title}</div>
                        
                            <br />
                            <span className="p-100 text-gray-900">{item.Description}</span>
                            <br />
                        ...
                        <br />  
                        <h1 className="p-100 text-gray-900 font-bold text-xl">Educational Background</h1>
                   
                        {Skills.map((item, index) => (
                            <span className="p-100 text-gray-900">{item.title}, </span>
                            ))}
                              <br />      <br />   
                            <h1 className="p-100 text-gray-900 font-bold text-xl">Work Experience  </h1>
...
<PrimaryButton onClick={() => appyNow()}>Apply Now </PrimaryButton>
